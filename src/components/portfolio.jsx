...
export default function Portfolio() {
    return (
       <div className="center">
            <h2 className="text">Projects Portfolio</h2>
            <div className="portfolio-container">
                ...
                <a href="https://github.com/adamouriel/calculatorproject.git" className="github-link" target="_blank" rel="noopener noreferrer">
